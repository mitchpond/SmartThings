...
metadata {
	...
	definition (name: "Quirky/Wink Tripper", namespace: "mitchpond", author: "Mitch Pond") {
        ...
        fingerprint profileID: "0104", deviceId: "0402", endpointId: "01", deviceVersion: "00", inClusters: "0000 0001 0003 0500 0020 0B05", outClusters: "0003 0019"
	}
...
def getBattery() {
	...
	log.trace "Requesting battery level.."
